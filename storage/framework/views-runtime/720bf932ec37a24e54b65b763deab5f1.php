    ...
    <body>
        <?php if(auth()->guard()->check()): ?>
            <div class="top-header">
                ...
                <div class="header-actions">
                    <span class="small text-muted d-none d-md-inline"><?php echo e(Auth::user()->name); ?></span>
        ...
        <div class="app-shell">
            <?php if(auth()->guard()->check()): ?>
                <aside class="sidebar">
                    <div>
                        <a class="sidebar-brand" href="<?php echo e(route('dashboard')); ?>">Habit Tracker</a>
                    ...
                    <nav class="sidebar-nav nav flex-column gap-2">
                        ...
                        <a class="nav-link <?php echo e(request()->routeIs('statistics') ? 'active' : ''); ?>" href="<?php echo e(route('statistics')); ?>">
                            <i class="fa-solid fa-chart-pie"></i>Statistics
                        </a>
                        <a class="nav-link <?php echo e(request()->routeIs('habits.create') ? 'active' : ''); ?>" href="<?php echo e(route('habits.create')); ?>">
                            <i class="fa-solid fa-plus"></i>Add Habit
                        </a>
                        <a class="nav-link <?php echo e(request()->routeIs('habits.manage', 'habits.edit') ? 'active' : ''); ?>" href="<?php echo e(route('habits.manage')); ?>">
                            <i class="fa-solid fa-list-check"></i>Manage Habits
                        </a>
                        <a class="nav-link <?php echo e(request()->routeIs('todos.*') ? 'active' : ''); ?>" href="<?php echo e(route('todos.index')); ?>">
...
<?php /**PATH D:\wamp64\www\habit_tracker\resources\views/layouts/app.blade.php ENDPATH**/ ?>